...
\item Built CUDA-accelerated data-processing and OpenGL visualization software for large waveform datasets, strengthening experience in GPU-enabled high-throughput pipelines.
...
\cvitem{ML}{PyTorch, PyTorch Geometric, scikit-learn, equivariant graph neural networks, diffusion-model theory}
