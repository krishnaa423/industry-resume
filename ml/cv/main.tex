...
\item Contributed ASP-style services and Microsoft SQL-backed data systems for engineering operations and tooling.
...
\item Combined HPC simulation infrastructure with CUDA/ROCm acceleration and scalable Python/C++ tooling to support ML-enabled scientific workloads.
\end{itemize}}
