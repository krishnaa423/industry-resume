...
\item Built database- and web-backed data-management tooling with ASP-style services and Microsoft SQL to collect, organize, and process large-scale well-tool datasets.
\end{itemize}}
