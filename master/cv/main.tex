...
\item Built CUDA-based data-processing pipelines and custom GPU-enabled engineering tooling for high-volume acoustic waveform datasets used in deployed well-logging tools.
